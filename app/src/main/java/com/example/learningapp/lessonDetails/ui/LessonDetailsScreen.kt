package com.example.learningapp.lessonDetails.ui
...
import com.example.learningapp.lessonDetails.ui.components.LessonDetailsActionButtons
import com.example.learningapp.lessonDetails.ui.components.LessonDetailsHeader
import com.example.learningapp.lessonDetails.ui.components.LessonDetailsInfoCard
...
fun LessonDetailsScreen(
    ...
    // BEST PRACTICE: Listen to lifecycle events to refresh data when returning to this screen
    DisposableEffect(lifecycleOwner) {
        val observer = LifecycleEventObserver { _, event ->
            if (event == Lifecycle.Event.ON_RESUME) {
                // Fetch the latest progress silently
                viewModel.loadLessonDetails(isRefresh = true)
            }
        }

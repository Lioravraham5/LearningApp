package com.example.learningapp.lessonEnd.di

import com.example.learningapp.lessonEnd.data.LessonEndRepository
import com.example.learningapp.lessonEnd.data.RemoteLessonEndRepositoryImpl
...
object LessonEndModule {
     ...
     * BEST PRACTICE: By explicitly binding the [RemoteLessonEndRepositoryImpl] to the [LessonEndRepository] interface,
    ...
    fun provideLessonEndRepository(
        ...
        return RemoteLessonEndRepositoryImpl(apiService)
    }
}
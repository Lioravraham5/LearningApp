package com.example.learningapp.lessonProgress.di

import android.content.Context
import com.example.learningapp.lessonProgress.data.LessonProgressRepository
import com.example.learningapp.lessonProgress.data.RemoteLessonProgressRepositoryImpl
import com.example.learningapp.lessonProgress.data.services.AndroidAudioRecorderService
import com.example.learningapp.lessonProgress.data.services.AudioRecorderService
import com.example.learningapp.lessonProgress.data.services.AzureTtsService
import com.example.learningapp.lessonProgress.data.services.TtsService
...
object LessonProgressModule {
     ...
     * actual implementation ([RemoteLessonProgressRepositoryImpl]) from the ViewModels.
    ...
    fun provideLessonProgressRepository(
        ...
        return RemoteLessonProgressRepositoryImpl(apiService)
    }
}
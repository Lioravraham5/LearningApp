package com.example.learningapp.categoryDetails.ui
...
import com.example.learningapp.categoryDetails.models.Lesson
import com.example.learningapp.categoryDetails.models.LessonDifficulty
...
fun CategoryDetailsScreen(
    ...
    // Get the current lifecycle owner to observe lifecycle events
    ...
    DisposableEffect(lifecycleOwner) {
        val observer = LifecycleEventObserver { _, event ->
            if (event == Lifecycle.Event.ON_RESUME) {
                ...
                viewModel.loadCategoryDetails(isRefresh = true)
            }
        }
